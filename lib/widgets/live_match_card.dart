...
class _LiveMatchCardState extends State<LiveMatchCard>
  ...
  Widget _teamsRow(CricScoreMatch match) {
    return Row(
      children: [
        Expanded(child: _teamCol(match.t1Short, match.t1s, true)),
        Padding(
        ...
        Expanded(child: _teamCol(match.t2Short, match.t2s, false)),
      ],
    );
  }

  Widget _teamCol(String shortName, String score, bool isLeft) {
    return Column(
      crossAxisAlignment:
